...
// Only use GPIO 16-19 for relay control
#define GPIO_0_MCU_ID 16
#define GPIO_1_MCU_ID 17
#define GPIO_2_MCU_ID 18
#define GPIO_3_MCU_ID 19
#define GPIO_0_DIRECTION GPIO_OUT
#define GPIO_1_DIRECTION GPIO_OUT
#define GPIO_2_DIRECTION GPIO_OUT
#define GPIO_3_DIRECTION GPIO_OUT
...
#define GPIO_MCU_IDS    GPIO_0_MCU_ID, GPIO_1_MCU_ID, GPIO_2_MCU_ID, GPIO_3_MCU_ID
#define GPIO_DIRECTIONS GPIO_0_DIRECTION, GPIO_1_DIRECTION, GPIO_2_DIRECTION, GPIO_3_DIRECTION
#define GPIO_PULLS      GPIO_0_PULL, GPIO_1_PULL, GPIO_2_PULL, GPIO_3_PULL
#define GPIO_IRQS       GPIO_0_IRQ_EN, GPIO_1_IRQ_EN, GPIO_2_IRQ_EN, GPIO_3_IRQ_EN
